...
namespace CressEditor.Extensions
{
	/// <summary>
	...
	public static class SerializedPropertyExtensions
	{
		...
		/// <exception cref="Exception">Property type is not primitive.</exception>
		...
		public static object GetPropertyValue(this SerializedProperty property)
		{
			...
			{
				default:
					throw new Exception("Cannot extract data from serialized property due to complex type.");

				case SerializedPropertyType.ArraySize:
					throw new NotImplementedException("Cannot extract data from ArraySize serialized property."); // TODO
